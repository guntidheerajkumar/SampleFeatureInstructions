...
namespace SampleFeatureInstructions
{
    public static class MaterialShowcaseCalculations
    {
        ...
        {
            return _center.Y < MaterialShowcase.OffsetThreshold
                || _materialShowcase.containerView.Frame.Height - _center.Y < MaterialShowcase.OffsetThreshold;
        }
        ...
        public static CGPoint GetOuterCircleCenterPoint(this MaterialShowcase _materialShowcase, UIView _target)
        {
            ...
            var onTop = _materialShowcase.GetTargetPosition(_materialShowcase.targetView, _materialShowcase.containerView)
                == MaterialShowcaseExtension.TargetPosition.Below;
            ...
            var centerY = onTop ? _target.Center.Y - MaterialShowcase.TargetHolderRadius - MaterialShowcase.TargetPadding
        ...
        public static float GetOuterCircleRadius(this MaterialShowcase _materialShowcase, CGPoint _center, CGRect _textBounds,
